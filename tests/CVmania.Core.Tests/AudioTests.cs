...
public class AudioTests
{
    ...
    {
        var src = TestSignal(44100, 3.0);
        var dir = Path.Combine(Path.GetTempPath(), "cvmania-tests");
    ...
    public void Exporter_WritesAudioAndBeatmap_WithVerifiedOffset()
    {
        ...
        var beatmap = CVmania.Core.Osu.OsuFile.Parse(OsuFileTests.Sample);
        var dir = Path.Combine(Path.GetTempPath(), "cvmania-tests", "export");
        ...
        var written = CVmania.Core.Osu.OsuFile.Load(report.BeatmapPath!);
